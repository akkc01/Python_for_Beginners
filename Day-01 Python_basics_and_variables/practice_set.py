...
print("Hello World!") # console me output ke liye print() function ka use hota hai

print("Hi Rahul", "How are you?", sep="-") 
print()
...
friends_details = {"name": "Rahul", "age": 25, "study": "Python"} # dictionary
